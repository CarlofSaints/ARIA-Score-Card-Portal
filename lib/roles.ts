...
export const ALL_PERMISSIONS: PermissionDef[] = [
  ...
  { key: "view_phantom", label: "View Phantom Stock", category: "view" },
  { key: "view_oos", label: "View Out of Stocks", category: "view" },
  { key: "view_nd", label: "View Numerical Distribution", category: "view" },
  { key: "view_sales", label: "View Sales", category: "view" },
  // Data
